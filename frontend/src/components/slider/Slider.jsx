...
const Slider = () => {
  ...
  return (
    ...
    >
      ...
      {/* slider controller */}
      <div className="absolute top-[40%] -translate-y-1/2 flex justify-between w-full px-10">
        {/* Previous button */}
        <div
          onClick={handlePrev}
          className="bg-white/80 hover:bg-white text-black p-3 rounded-full cursor-pointer
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto w-full px-6">
          ...
          >
            ...
            <p className="text-lg mb-6">{slideInfo[current].description}</p>
